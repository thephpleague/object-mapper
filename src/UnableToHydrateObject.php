...
final class UnableToHydrateObject extends RuntimeException
{
    ...
    public static function noMapperDefined(string $className, array $stack = []): static
    {
        return new static("Unable to hydrate object: $className, no mapper defined", stack: $stack);
    }
